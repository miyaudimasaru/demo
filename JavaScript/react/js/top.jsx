    ...
    for(var i = 0;i < data.length;i++){
      ...
      urlBox.push(
        <div className="section-inner">
          <p>
            <a href={urlTop} className="isHover" target="_blank"><img ref="" src={imgUrl}/></a>
          </p>
        </div>
      );
      Box.push(
    ...
    return (
      <div className="footerInner">
        ...
        <div className="textBox">
          <p>“
            <span><img ref="" src="public/img/common/textin01.png" alt=""/>
              </span>
            “、“PlayStation”および “
  ...
  render: function(){
    ...
    return (
      <div className="footerInner">
        ...
        <div className="textBox">
          <p>“<span><img src="public/img/about/textin01.png" alt=""/></span>“、“PlayStation”および “<span><img src="public/img/about/textin02.png" alt=""/></span>“は株式会社ソニー・インタラクティブ<br />エンタテインメントの登録商標または商標です。 </p>
          <p>Nintendo Switchのロゴ・Nintendo Switchは任天堂の商標です。</p>
